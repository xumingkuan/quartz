...
void benchmark_nam(const std::string &circuit_name) {
  ...
  // Construct contexts
  Context src_ctx({GateType::h, GateType::s, GateType::sdg, GateType::t, GateType::tdg,
                   GateType::input_qubit, GateType::input_param});
  Context dst_ctx({GateType::h, GateType::s, GateType::sdg, GateType::t, GateType::tdg,
                   GateType::input_qubit, GateType::input_param});
...
int main() {
  if (!std::filesystem::exists(ecc_set_name)) {
    ...
    gen_ecc_set({GateType::h, GateType::s, GateType::sdg, GateType::t, GateType::tdg}, ecc_set_prefix, true, 1, 0, 5);
//    gen_ecc_set(
